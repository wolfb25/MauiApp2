	...
	public partial class MainPage : ContentPage {
		...
		private void CalculateMachNumber(object sender, EventArgs e) {
			...
			try {
				...
				if (m < 1) results.Add($"qc={q} p0={p} Ma={m}");
				else DisplayAlert("Hiba", "A Mach-szám értéke nagyobb vagy egyenlő mint 1.", "OK");
			}
			catch (Exception ex) { DisplayAlert("Hiba", ex.Message, "OK"); }
		}
	}
